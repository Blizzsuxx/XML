...
@XmlType(name = "TVakcina", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji", propOrder = {
    "pfizer",
    "sinopharm",
    "moderna",
    "sputnik",
...
public class TVakcina {
    ...
    @XmlElement(name = "Pfizer", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
    protected String pfizer;
    @XmlElement(name = "Sinopharm", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
    protected String sinopharm;
    @XmlElement(name = "Moderna", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
    protected String moderna;
    @XmlElement(name = "Sputnik", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
    protected String sputnik;
    @XmlElement(name = "AstraZeneca", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
