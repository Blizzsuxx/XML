...
@XmlType(name = "TPol", namespace = "http://ftn.uns.ac.rs/saglasnost", propOrder = {
    "musko",
    "zensko"
})
public class TPol {
    @XmlElement(name = "Musko", namespace = "http://ftn.uns.ac.rs/saglasnost")
    protected String musko;
    @XmlElement(name = "Zensko", namespace = "http://ftn.uns.ac.rs/saglasnost")
