...
@XmlType(name = "TVakcina", namespace = "http://ftn.uns.ac.rs/interesovanje", propOrder = {
    "pfizer",
    "sinopharm",
    "moderna",
    "sputnik",
...
public class TVakcina {
    ...
    @XmlElement(name = "Pfizer", namespace = "http://ftn.uns.ac.rs/interesovanje")
    protected String pfizer;
    @XmlElement(name = "Sinopharm", namespace = "http://ftn.uns.ac.rs/interesovanje")
    protected String sinopharm;
    @XmlElement(name = "Moderna", namespace = "http://ftn.uns.ac.rs/interesovanje")
    protected String moderna;
    @XmlElement(name = "Sputnik", namespace = "http://ftn.uns.ac.rs/interesovanje")
    protected String sputnik;
    @XmlElement(name = "AstraZeneca", namespace = "http://ftn.uns.ac.rs/interesovanje")
