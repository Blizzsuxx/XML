...
@XmlType(name = "TPol", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji", propOrder = {
    "musko",
    "zensko"
})
public class TPol {

    @XmlElement(name = "Musko", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
    protected String musko;
    @XmlElement(name = "Zensko", namespace = "http:/www.ftn.uns.ac.rs/izvestaj_o_imunizaciji")
